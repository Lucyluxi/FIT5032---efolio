<template>
    <div class="container mt-5">
        <div class="row">
            <div class="head col-md-4 offset-md-4 text-center mb-3">
                <h1>WEATHER APP</h1>
            </div>
            <div class="search-bar col-md-4 offset-md-4 text-center mb-5">
                <input type="text" v-model="city" placeholder="Enter city name" class="search-input"></input>
                <button @click="searchByCity" class="search-button">Search</button>
            </div>
            <!--The <main> tag in HTML is used to specify the main content of a document 
        More info about main, check https://www.w3schools.com/tags/tag_main.asp-->  
        <main class="col-md-4 offset-md-4 text-center">
...
const apikey = "6305154d8734b01127a5ad0fad33d8ef";
